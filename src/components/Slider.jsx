        ...
        <CCarouselItem>
          <div className="image-wrapper">
            ...
            <div className="image-links">
              <a href="https://budget-app-niq8.onrender.com" target="_blank" className="live-demo-link">Live Demo</a>
              <a href="https://github.com/PromzzyKoncepts/Budget-App" target="_blank" className="github-link">Github</a>
            </div>
          </div>
